      ...
      <div className="max-w-7xl mx-auto px-3">
        <div className="flex items-center justify-between h-14">
          ...
          <ul className="flex space-x-7">
            <li>
              <Link to="/" className="text-gray-500 hover:text-pink-400 hover:border-b-2 py-1 border-transparent transition-all duration-100 hover:border-pink-400">
                Home
              </Link>
            </li>
            {user && (
              <>
                <li>
                  <Link to="/photo" className="text-gray-500 hover:text-pink-400 hover:border-b-2 py-1 border-transparent transition-all duration-100 hover:border-pink-400">
                    Photos
                  </Link>
                </li>
                <li>
                  <Link to="/courses" className="text-gray-500 hover:text-pink-400 hover:border-b-2 py-1 border-transparent transition-all duration-100 hover:border-pink-400">
                    Courses
                  </Link>
                </li>
                <li>
                  <Link to="/competition" className="text-gray-500 hover:text-pink-400 hover:border-b-2 py-1 border-transparent transition-all duration-100 hover:border-pink-400">
                    Competition
                  </Link>
                </li>
              </>
